...
import { XP_SETTINGS, UNLOCK_LEVELS, ENCHANTMENT_REQUIREMENTS, ENCHANTMENT_OUTCOMES, ENCHANTER_STATS, HOME_BASE_PRODUCTION, BALL_FAMILIES } from '../balancing.js';
...
export function initializeInput(gameController, runCode) {
    ...
    dom.cheatUnlockAllBallsBtn.addEventListener('click', () => {
        ...
        // Derive all ball types from families (excluding giant)
        const types = [];
