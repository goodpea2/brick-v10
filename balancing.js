...
export const ROSTER_CONSTANTS = {
    ...
    SCRAP_ENCHANTMENT_BONUS: [0, 0, 1, 4, 12, 27, 55, 107, 185, 302] // By Level (Index = Level - 1)
};
...
export const ENCHANTMENT_OUTCOMES = {
    classic: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Chain Damage', text: '+2 Chain Damage', apply: (stats) => stats.bonusChainDamage = (stats.bonusChainDamage || 0) + 2 } },
    strong: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+19% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.19 }, C: { name: 'Chain Damage', text: '+2 Chain Damage', apply: (stats) => stats.bonusChainDamage = (stats.bonusChainDamage || 0) + 2 } },
    lightning: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Chain Damage', text: '+2 Chain Damage', apply: (stats) => stats.bonusChainDamage = (stats.bonusChainDamage || 0) + 2 } },
    explosive: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up', text: '+0.2 Explosion Radius', apply: (stats) => stats.bonusPowerUpValue = (stats.bonusPowerUpValue || 0) + 0.2 } },
    draining: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Explosion Damage', text: '+15% Damage', apply: (stats) => stats.explosionDamageMultiplier = (stats.explosionDamageMultiplier || 1.0) * 1.15 } },
    spray: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up', text: '+0.2 Explosion Radius', apply: (stats) => stats.bonusPowerUpValue = (stats.bonusPowerUpValue || 0) + 0.2 } },
    piercing: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Shield Duration', text: '+0.7s Shield Duration', apply: (stats) => stats.bonusEnergyShieldDuration = (stats.bonusEnergyShieldDuration || 0) + 0.7 } },
    phaser: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up Damage Buff', text: '+2 Power-up Damage', apply: (stats) => stats.bonusPowerUpDirectDamage = (stats.bonusPowerUpDirectDamage || 0) + 2 } },
    grow: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Shield Duration', text: '+0.7s Shield Duration', apply: (stats) => stats.bonusEnergyShieldDuration = (stats.bonusEnergyShieldDuration || 0) + 0.7 } },
    split: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Armor', text: '+1 Armor', apply: (stats) => stats.bonusMainBallArmor = (stats.bonusMainBallArmor || 0) + 1 } },
    cluster: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Armor', text: '+1 Armor', apply: (stats) => stats.bonusMainBallArmor = (stats.bonusMainBallArmor || 0) + 1 } },
    cell: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Vampire Heal', text: '+2 Heal on Break', apply: (stats) => stats.bonusVampireHeal = (stats.bonusVampireHeal || 0) + 2 } },
    brick: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up Mines', text: '+1 Power-up Mine', apply: (stats) => stats.bonusPowerUpMineCount = (stats.bonusPowerUpMineCount || 0) + 1 } },
    cross: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up Mines', text: '+1 Power-up Mine', apply: (stats) => stats.bonusPowerUpMineCount = (stats.bonusPowerUpMineCount || 0) + 1 } },
    hollow: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up Mines', text: '+1 Power-up Mine', apply: (stats) => stats.bonusPowerUpMineCount = (stats.bonusPowerUpMineCount || 0) + 1 } },
    bullet: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Last Power-up Bullets', text: '+4 Last Power-up Bullets', apply: (stats) => stats.bonusLastPowerUpBulletCount = (stats.bonusLastPowerUpBulletCount || 0) + 4 } },
    octo: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Last Power-up Bullets', text: '+6 Last Power-up Bullets', apply: (stats) => stats.bonusLastPowerUpBulletCount = (stats.bonusLastPowerUpBulletCount || 0) + 6 } },
    gatling: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Bullet Count', text: '+2 Power-up Bullets', apply: (stats) => stats.bonusBulletCount = (stats.bonusBulletCount || 0) + 2 } },
    homing: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Homing Damage', text: '+10 Homing Damage', apply: (stats) => stats.bonusHomingExplosionDamage = (stats.bonusHomingExplosionDamage || 0) + 10 } },
    seeker: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Homing Damage', text: '+5 Homing Damage', apply: (stats) => stats.bonusHomingExplosionDamage = (stats.bonusHomingExplosionDamage || 0) + 5 } },
    chase: { A: { name: 'HP', text: '+15% Max HP', apply: (stats) => stats.hpMultiplier *= 1.15 }, B: { name: 'Damage', text: '+26% Base Damage', apply: (stats) => stats.damageMultiplier *= 1.26 }, C: { name: 'Power-up Damage Buff', text: '+2 Power-up Damage', apply: (stats) => stats.bonusPowerUpDirectDamage = (stats.bonusPowerUpDirectDamage || 0) + 2 } },
};
